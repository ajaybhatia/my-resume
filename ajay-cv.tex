...
%{\em CEO} \hfill {\bf July, 2016 - Current}
%
...
\textbf{Developed \& Design} YuPlayGod Downloads (Official), a web app maintaining various ROM builds for YU series of smartphones

\textbf{Developed \& Design} YuPlayGod Developers (Official), a web app for Project Highway by YU Televentures

\textbf{Developed \& Design} Taxi Cab Dulles, a wesite for cab company in Dulles (US)

\textbf{Developed \& Design} PhotoBucketStudio, a web app for sharing professional photography work

\textbf{Developed \& Design} Kespripane.com, a punjabi dictionary and search engine
...
\textbf{Developed \& Design} The Possibility Engine for Thicket Labs LLC in hybrid technologies
...
\textbf{Developed \& Design} www.drinking.dachb.com, a survey web app for collecting data of Binge drinkers

\textbf{Developed \& Design} cheal.info, a Computational Healcare (cHeal) Lab website for Lakehead University

\textbf{Developed} TECHN0VIBES 2015 - an IT Club website for managing various activities and for administrative purpose in Python/web2py https://itclub.pythonanywhere.com
...
Programming in C and C++ languages (8 times, since 2008)

Programming in Java (8 times, Since 2008)

Introduction to Computers \& IT (4 times, since 2008)

Data Structure (3 times, since 2008)
...
\begin{list2}
\item Languages:  C, C++, Java, Python, Ruby, MATLAB, ASP.NET, C\#.NET, Unix Shell Scripting, HTML, CSS, JavaScript, jQuery, Bootstrap, PHP, XML, Rails Framework, Django Framework, web2py Framework, Meteor, JSF Framework, Laravel Framework, CodeIgnitor Framework, Fuzzy logic and Neural Network toolboxes in MATLAB\\
\item Applications: \LaTeX, MySQL, MS-SQL Server, Apache Webserver, GlassFish Application \& Webserver, IIS, Spreadsheet, and Presentation software\\
\item Operating Systems:  Unix/Linux, Windows, Mac\\
\end{list2}
